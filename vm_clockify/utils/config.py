...
class Settings(BaseSettings):
    ...
    WORK_TIME_DEFAULT_ISSUE: Union[str, None] = config("WORK_TIME_DEFAULT_ISSUE", default=None)
    WORK_TIME_DEFAULT_COMMENT: Union[str, None] = config("WORK_TIME_DEFAULT_COMMENT", default=None)
    # ------------------------------------------------------------------------------
    #
    # CLOCKIFY
    #
