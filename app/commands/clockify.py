...
@click.option('-k', '--key', type=str,
              help=f'api key for clockify [{settings.CLOCKIFY_API_KEY}]', default=settings.CLOCKIFY_API_KEY, required=True)
@click.option('-e', '--endpoint', type=str,
              help=f'full api endpoint [{settings.CLOCKIFY_API_ENDPOINT}]', default=settings.CLOCKIFY_API_ENDPOINT, required=True)
@pass_context
...
@click.option('-w', '--workspace-id', type=str,
              help=f'workspace to use [{settings.CLOCKIFY_API_WORKSPACE_ID}]', default=settings.CLOCKIFY_API_WORKSPACE_ID, required=True)
@click.option('-u', '--user-id', type=str,
              help=f'user to use [{settings.CLOCKIFY_API_USER_ID}]', default=settings.CLOCKIFY_API_USER_ID, required=True)
